...
CREATE TABLE IF NOT EXISTS submissions (
  id TEXT PRIMARY KEY, external_id TEXT, author_token_hmac TEXT NOT NULL UNIQUE,
...
CREATE TABLE IF NOT EXISTS mock_reviews (
  ...
  reviewer_login TEXT NOT NULL, kind TEXT NOT NULL, body TEXT NOT NULL,
  path TEXT, line INTEGER, state TEXT, created_at TEXT NOT NULL
);
`;

export class AIDaRDatabase {
